                    ...
                    <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                      ...
                      <form method="post" action="{{ route('profile.update') }}">
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-md-8 col-lg-9">
                            <input name="name" type="text" class="form-control" id="name" value="{{ Auth::user()->name }}" autofocus autocomplete="name">
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-md-8 col-lg-9">
                            <input name="email" type="email" class="form-control" id="Email"  value="{{ Auth::user()->name }}" autocomplete="username">
